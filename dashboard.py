        ...
        html.Div([
            ...
            dcc.Dropdown(
                ...
                options=[
                    ...
                    {'label' : 'Variation Autoencoder', 'value' : 'VAE'},
        ...
        html.Div([
            ...
            html.Div([
                dcc.RadioItems(
                    ...
                    value='Plasma',
                    labelStyle={'float': 'right', 'display': 'inline-block', 'margin-right': 40}
                ),
                ], style={'width': '49%', 'display': 'inline-block', 'float': 'right'}),
            
            dcc.Dropdown(
                id='crossfilter-feature',
                options=[{'label':i,'value':i} for i in ['None', 'Region', 'Channel', 'Total Spend'] + features],
                value='None',
                clearable=False
